...
{
  options.galaxy.desktop.udevil.enable = lib.mkEnableOption "udevil automounting and udev rules";

  config = lib.mkIf config.galaxy.desktop.udevil.enable {
    environment.variables.UDEVIL_CONF_PATH = "/etc/udevil/udevil.conf";
